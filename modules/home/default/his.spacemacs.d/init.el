...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(ein editorconfig)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(sanityinc-tomorrow-bright sanityinc-tomorrow-night sanityinc-tomorrow-eighties sanityinc-solarized-light sanityinc-tomorrow-day)
   ...
   dotspacemacs-default-font '("Monaco" :size 13.0 :weight normal :width normal)
...
before packages are loaded."
  ...
  ;; (editorconfig-mode 1)
  ;; work around mouse wheel scrolling problem when client is run in
  ;; a MacOS terminal
  ;; see https://github.com/syl20bnr/spacemacs/issues/4591#issuecomment-402212204
  ;;(xterm-mouse-mode -1)

  ;; Rust
  (add-hook 'rust-mode-hook #'(lambda() (turn-on-auto-fill) (set-fill-column 80)))

  ;; TODO temporary workaround for rg 14, remove when fixed
  (setq helm-ag-use-grep-ignore-list nil)


  (defun setup-term-exec ()
    ;; enable unicode characters in terminal
    ;; see https://stackoverflow.com/a/7437783/1173529
